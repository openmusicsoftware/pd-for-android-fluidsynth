...
LOCAL_MODULE := fluidsynth_tilde
LOCAL_C_INCLUDES := $(LOCAL_PATH)/pure-data/src \
$(LOCAL_PATH)/pure-data/extra/fluidsynth~/fluidsynth-2.2.4-android24/include
LOCAL_CFLAGS := -DPD
LOCAL_SRC_FILES := pure-data/extra/fluidsynth~/fluidsynth~.c
LOCAL_SHARED_LIBRARIES := pd fluidsynth-prebuilt
